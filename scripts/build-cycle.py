...
TOOLS = {
    "noon": {
        ...
        "scores": {
            ...
            "autonomous_search": ([2, 2, 1, 2], "Sources continuously from a role brief; keeps monitoring as new candidates enter the market"),
            "autonomous_screening": ([2, 2, 2, 1], "Per-candidate verdicts with reasoning against calibrated role criteria across the full pool"),
            "autonomous_outreach": ([2, 2, 2, 1], "Multi-touch personalized sequences sent and followed up automatically; multi-channel automation partial"),
            "scheduling_automation": ([2, 2, 1, 1], "AI coordinator answers candidate questions and collects availability; direct booking and rescheduling newer than incumbent scheduling stacks"),
            ...
            "reply_handling": ([2, 2, 1, 2], "Coordinator handles candidate Q&A and logistics through to booking"),
            "source_breadth": ([2, 2, 1, 1, 1], "Web-wide sourcing beyond LinkedIn incl. technical sources; smaller aggregated index than hireEZ/SeekOut"),
            "contact_finding": ([2, 1, 2, 1], "Built-in email enrichment and verification; phone coverage thinner"),
